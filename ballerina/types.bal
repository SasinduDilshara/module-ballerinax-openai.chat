...
public type ChatCompletionMessageList record {
    ...
    record {*ChatCompletionResponseMessage; string id; (ChatCompletionRequestMessageContentPartText|ChatCompletionRequestMessageContentPartImage)[] content_parts?;}[] data;
